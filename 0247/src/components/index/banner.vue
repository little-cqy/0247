<template>
    <div class="banner">
        ...
        <div class="longBanner" :style="`margin-left:-${page*width}px;width:${(list.length+2)*width}px`">
            <div class="bn-details" :style="`width:${width}px`"  @touchend="touchend" @touchstart="touchstart" @touchmove="touchmove">
            ...
            <div class="bn-details" :style="`width:${width}px`" v-for="(key,i) of list" :key="i" @touchend="touchend" @touchstart="touchstart" @touchmove="touchmove">
